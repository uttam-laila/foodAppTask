...
class MockData {
  List<Map<String, dynamic>> response = FetchData().getDataFromAPI();
  /* List<Map<String, dynamic>> response = responseSend != null
      ? responseSend
      : [
          {
            ...
            "table_menu_list": [
              {
                ...
                "category_dishes": [
                  ...
                  },
                  {
                    ...
                    "dish_calories": 30.0,
                    "dish_description":
                        "Flour Mixed with fresh green leafy vegetables",
                    "dish_Availability": true,
                    "dish_Type": 2,
                    "nexturl":
                  ...
                  },
                  {
                    ...
                    "dish_calories": 25.0,
                    "dish_description":
                        "One-Pot-Vegetarian-Orzo-Vegetable-Soup",
                    "dish_Availability": false,
                    "dish_Type": 1,
                    "nexturl":
